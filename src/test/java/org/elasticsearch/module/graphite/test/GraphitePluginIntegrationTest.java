...
public class GraphitePluginIntegrationTest {
    ...
    public void testThatIndexingResultsInMonitoring() throws Exception {
        ...
        //assertGraphiteMetricIsContained("elasticsearch." + clusterName + ".node.rec004reh.jvm.threads.peakCount ");
    }
    ...
    public void testThatFieldExclusionWorks() throws Exception {
        ...
        ensureValidKeyNames();
        //assertGraphiteMetricIsNotContained("elasticsearch." + clusterName + ".node.rec004reh.jvm.threads.peakCount ");
    }
